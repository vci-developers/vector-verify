  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <div className="grid grid-cols-3 gap-2">
        <AnnotationStatusCard icon={FileCheck} variant="primary" label="Completed" count={annotated} />
        <AnnotationStatusCard icon={Clock} variant="warning" label="Pending" count={pending} />
        <AnnotationStatusCard icon={AlertCircle} variant="destructive" label="Flagged" count={flagged} />
      </div>
    </div>
  );
}
