...
import OperationsSiteHierarchy from '@/features/operations/components/operations-site-hierarchy';

interface OperationsSitesListProps {
    sites: Site[];
    district: string;
    startDate?: string;
    endDate?: string;
...
export default function OperationsSitesList({
    sites,
    district,
    startDate,
    endDate,
}: OperationsSitesListProps) {
