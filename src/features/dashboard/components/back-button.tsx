                    ...
                    <>
                      ...
                      <Button
                        ...
                        className={cn(
                          'h-10 w-full justify-start gap-3 pl-8',
                          isActivePath(
                            `/review/${district}/${monthYear}/session-view`,
                          ) &&
                            'bg-green-50 text-green-700 hover:bg-green-100 hover:text-green-700',
                        )}
                        onClick={() =>
                      ...
                      <Button
                        ...
                        className={cn(
                          'h-10 w-full justify-start gap-3 pl-8',
                          isActivePath(
                            `/review/${district}/${monthYear}/specimen-view`,
                          ) &&
                            'bg-green-50 text-green-700 hover:bg-green-100 hover:text-green-700',
                        )}
                        onClick={() =>
                      ...
                      <Button
                        ...
                        className={cn(
                          'h-10 w-full justify-start gap-3 pl-8',
                          isActivePath(
                            `/review/${district}/${monthYear}/data-quality`,
                          ) &&
                            'bg-green-50 text-green-700 hover:bg-green-100 hover:text-green-700',
                        )}
                        onClick={() =>
                ...
                <div className="space-y-1">
                  ...
                  >
                    <List
                      className={cn(
                        'h-4 w-4',
                        isOnAnnotationList && 'text-green-600',
                      )}
                    />
