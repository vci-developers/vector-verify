    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
        <InfoCard
          ...
          tooltipContent="This represents the total count of Long-Lasting Insecticidal Nets (LLINs) found in all surveyed households. This metric helps assess the availability of protective bednets in the community and is used to evaluate coverage of vector control interventions."
        />
        <InfoCard
